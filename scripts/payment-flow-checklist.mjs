...
const productionNotes = [
  ...
  'Midtrans webhook/status sync uses transaction-aware local order/access/audit updates when PostgreSQL is configured.',
  ...
  'Admins can dry-run or apply old PENDING order sync with POST /api/payments/midtrans-reconcile.',
...
const checklist = [
  ...
  'With PostgreSQL, confirm webhook/status order update, access request update, and audit log commit together.',
